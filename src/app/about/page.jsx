...
export default function AboutUs() {
  ...
  const progressDesc =
    ...
    "We have successfully created the first iteration of our rover—it moves! We have also demonstrated a proof of concept of our novel microplastic filtration system. Right now, we are focusing on improving our rover design and functionality, as well as integrating our filtration system into our rover. Our team is also working towards finalizing the first iteration of the charging and housing station for our rover in order to make it self-sufficient."
  const storyDesc =
